...
typedef struct pxprpc_server_tbox_api{
    pxprpc_server_tbox (*new_server)(tb_socket_ref_t sock,const struct pxprpc_namedfunc *namedFunc,int lenOfNamedFunc);
    void (*serve_block)(pxprpc_server_tbox tbox);
    int (*delete_server)(pxprpc_server_tbox serv);
}pxprpc_server_tbox_api;
