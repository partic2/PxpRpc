...
PXPRPC_RTBRIDGE_LDFLAGS= pxprpc_rtbridge.o $(PXPRPC_LDFLAGS) $(PXPRPC_PIPE_LDFLAGS) $(LIBUV_LDFLAGS)

pxprpc_rtbridge_test:test.c build_pxprpc_rtbridge
	$(CC) -o __temp_test.exe $(CFLAGS) $(PXPRPC_RTBRIDGE_CFLAGS) test.c $(PXPRPC_RTBRIDGE_LDFLAGS)
